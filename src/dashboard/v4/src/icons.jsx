/* v4 Icon set — fixed stroke/fill so icons are always visible on dark surfaces.
 * Every icon uses currentColor for strokes; filled accents use currentColor explicitly.
 */
const Icon = ({ name, size = 16, className = '', style = {} }) => {
  ...
  switch(name) {
    ...
    case 'para': return <svg {...p}><rect x="3" y="3" width="8" height="8"/><rect x="13" y="3" width="8" height="8"/><rect x="3" y="13" width="8" height="8"/><rect x="13" y="13" width="8" height="8"/><circle cx="7" cy="7" r="1.4" fill="currentColor" stroke="none"/><circle cx="17" cy="7" r="1.4" fill="currentColor" stroke="none"/><circle cx="7" cy="17" r="1.4" fill="currentColor" stroke="none"/><circle cx="17" cy="17" r="1.4" fill="currentColor" stroke="none"/></svg>;
    case 'tasks': return <svg {...p}><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 9h3M7 13h6M7 17h4"/><path d="M14 9l1.5 1.5L18 8"/></svg>;
    ...
    case 'vault': return <svg {...p}><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="14" cy="12" r="3"/><path d="M14 9v1M14 14v1M11 12h1M16 12h1"/><path d="M5 7h3M5 17h3"/></svg>;
    case 'dream': return <svg {...p}><path d="M21 13a8.5 8.5 0 0 1-10-10 8 8 0 1 0 10 10Z"/><path d="M16 4l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2Z" fill="currentColor" stroke="none" opacity=".5"/></svg>;
    ...
    case 'mcp': return <svg {...p}><rect x="3" y="6" width="18" height="6" rx="2"/><rect x="3" y="14" width="18" height="6" rx="2"/><circle cx="7" cy="9" r="0.6" fill="currentColor" stroke="none"/><circle cx="7" cy="17" r="0.6" fill="currentColor" stroke="none"/></svg>;
    ...
    case 'discord': return <svg {...p}><path d="M5 7c2-1 4-1.5 7-1.5S17 6 19 7l1 11c-2 1-4 1.5-5 1.5l-1-2c-1 .5-2 .5-2 .5s-1 0-2-.5l-1 2c-1 0-3-.5-5-1.5L5 7Z"/><circle cx="9" cy="13" r="1" fill="currentColor" stroke="none"/><circle cx="15" cy="13" r="1" fill="currentColor" stroke="none"/></svg>;
    ...
    case 'alert': return <svg {...p}><path d="M10.3 3.9L1.8 17A2 2 0 0 0 3.5 20h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><line x1="12" y1="9" x2="12" y2="14"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>;
    ...
    case 'terminal': return <svg {...p}><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M6 9l3 3-3 3M12 15h6"/></svg>;
    case 'docs': return <svg {...p}><path d="M5 4h11l3 3v13H5z"/><path d="M16 4v3h3"/><path d="M8 10h8M8 14h8M8 18h5"/></svg>;
    case 'canvas': return <svg {...p}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/><circle cx="15" cy="15" r="1.4" fill="currentColor" stroke="none"/></svg>;
    case 'image': return <svg {...p}><rect x="3" y="6" width="18" height="12" rx="2"/><path d="M3 16l5-5 4 4 4-4 5 5"/></svg>;
    case 'logo': return (
      <svg className={'ico ' + className} style={s} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none">
        <defs>
          <linearGradient id="v4-lg1" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" stopColor="var(--accent)"/>
            <stop offset="1" stopColor="var(--accent-hover)"/>
          </linearGradient>
        </defs>
        <path d="M4 6 L16 2 L28 6 L28 18 C28 24 22 28 16 30 C10 28 4 24 4 18 Z" fill="none" stroke="url(#v4-lg1)" strokeWidth="1.4"/>
        <path d="M10 12 L16 8 L22 12 L22 18 L16 22 L10 18 Z" fill="none" stroke="var(--accent)" strokeWidth="1.2"/>
        <circle cx="16" cy="15" r="1.6" fill="var(--accent)" stroke="none"/>
        <path d="M11 15h-3M24 15h-3M16 8V5M16 22v3" stroke="var(--accent)" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    );
    case 'circle-dot': return <svg {...p}><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="3" fill="currentColor" stroke="none"/></svg>;
